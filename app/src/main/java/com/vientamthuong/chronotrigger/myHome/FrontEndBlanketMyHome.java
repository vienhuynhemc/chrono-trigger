...
public class FrontEndBlanketMyHome implements Observer {
    ...
    public FrontEndBlanketMyHome(ImageView imageView, int x, int y, int z, AppCompatActivity appCompatActivity, GameWorldMyHome gameWorldMyHome) {
    ...
    private void init() {
        ...
        animation = SourceAnimation.getInstance().getAnimation("tang_tren_men_my_home");
    }
