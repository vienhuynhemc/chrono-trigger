...
public class ObjectFullScreenMyHomeGround implements Observer {
    ...
    public ObjectFullScreenMyHomeGround(ImageView imageView, AppCompatActivity appCompatActivity, GameWorldMyHomeGround gameWorldMyHomeGround) {
